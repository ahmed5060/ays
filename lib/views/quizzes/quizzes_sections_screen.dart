...
import 'package:courses_app/views/quizzes/quizzes_screen.dart';
...
import 'quizzes_sub_sections_widget.dart';

class QuizzesSectionsScreen extends StatefulWidget {
  const QuizzesSectionsScreen({Key? key, required this.id}) : super(key: key);
  final int id;

  @override
  State<QuizzesSectionsScreen> createState() => _QuizzesSectionsScreenState();
}
...
class _QuizzesSectionsScreenState extends State<QuizzesSectionsScreen> {
  @override
  void initState() {
    super.initState();
