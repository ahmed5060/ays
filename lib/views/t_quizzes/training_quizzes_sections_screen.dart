...
import 'package:courses_app/views/t_quizzes/training_quizzes_sub_sections_widget.dart';
...
class TrainingQuizzesSectionsScreen extends StatefulWidget {
  const TrainingQuizzesSectionsScreen({Key? key, required this.id})
      : super(key: key);
  final int id;

  @override
  State<TrainingQuizzesSectionsScreen> createState() =>
      _TrainingQuizzesSectionsScreenState();
}
...
class _TrainingQuizzesSectionsScreenState
    extends State<TrainingQuizzesSectionsScreen> {
  @override
  void initState() {
    super.initState();
    ...
    return SafeArea(
      child: Consumer<TrainingQuizProvider>(builder: (context, provider, _) {
        return Column(
          children: [
            MainAppBarWidget(
              title: 'Training Quizzes Section',
